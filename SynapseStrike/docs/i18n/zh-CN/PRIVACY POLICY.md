...
本隐私政策（以下简称“政策”）旨在告知您，作为我们网站的用户，我们如何处理您的个人信息。本政策适用于 SynapseStrike（以下简称“我们”或“我方”）作为数据控制者，处理通过 synapsestrikeai.com 及其任何子域名（以下简称“网站”）收集的信息。

B. 核心政策区别：网站数据与软件数据

本政策的核心是区分“网站”和“软件”。
网站数据：本政策管辖我们收集和处理的、来自我们“网站”访问者的个人信息。
软件数据：本政策 不适用于 您在您自行下载、安装和运行的 SynapseStrike AI 交易操作系统（以下简称“软件”）的自托管（Self-Hosted）实例中处理的任何数据。
...
我们（SynapseStrike）是一个非托管（Non-Custodial）软件提供商。这意味着我们从不持有、控制或访问您的资金、资产或敏感凭证。
