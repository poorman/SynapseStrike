Пользовательское соглашение SynapseStrike (Условия предоставления услуг)
...
Настоящее Пользовательское соглашение (далее «Соглашение» или «Условия») является юридически обязывающим договором между вами (далее «вы» или «Пользователь») и SynapseStrike (далее «мы» или «SynapseStrike»).

B. Сфера применения

Настоящее Соглашение регулирует ваш доступ к веб-сайту synapsestrikeai.com (далее «Веб-сайт») и его использование, а также загрузку, установку и использование операционной системы SynapseStrike AI для торговли (далее «Программное обеспечение»).
...
Лицензия AGPL-3.0: Мы явно информируем вас о том, что исходный код Программного обеспечения SynapseStrike предоставляется вам на условиях лицензии GNU Affero General Public License v3.0 (AGPL-3.0) (далее «AGPL-3.0»).
...
НАСТОЯЩЕЕ СОГЛАШЕНИЕ (ВМЕСТЕ С ЛИЦЕНЗИЕЙ НА ПРОГРАММНОЕ ОБЕСПЕЧЕНИЕ AGPL-3.0) ПРЕДСТАВЛЯЕТ СОБОЙ ПОЛНОЕ СОГЛАШЕНИЕ МЕЖДУ ВАМИ И SynapseStrike ОТНОСИТЕЛЬНО ПРЕДМЕТА ДОГОВОРА.
