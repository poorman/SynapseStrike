SynapseStrike Terms of Service
...
These Terms of Service (the "Agreement" or "Terms") constitute a legally binding agreement between you (the "User" or "you") and SynapseStrike ("we," "our," or "SynapseStrike").

B. Scope

These Terms govern your access to and use of the website synapsestrikeai.com (the "Website"), as well as your download, installation, and use of the SynapseStrike AI Trading Operating System (the "Software").
...
AGPL-3.0 License: We expressly inform you that the source code of the SynapseStrike Software is provided to you under the GNU Affero General Public License v3.0 (AGPL-3.0) (the "AGPL-3.0").
...
YOU ACKNOWLEDGE AND AGREE THAT WE (SynapseStrike) ARE A NON-CUSTODIAL SOFTWARE PROVIDER. WE NEVER COLLECT, STORE, RECEIVE, OR IN ANY WAY ACCESS YOUR API KEYS, PRIVATE KEYS, OR SEED PHRASES. WE WILL NEVER REQUEST THAT YOU SHARE THESE CREDENTIALS.
...
TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, SynapseStrike (AND ITS AFFILIATES, DIRECTORS, EMPLOYEES, OR LICENSORS) SHALL NOT BE LIABLE TO YOU UNDER ANY CIRCUMSTANCES FOR ANY INDIRECT, PUNITIVE, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR EXEMPLARY DAMAGES, INCLUDING BUT NOT LIMITED TO LOSS OF PROFITS, FUNDS, OR DATA, OR DAMAGES RESULTING FROM THEFT OR LOSS OF YOUR API KEYS OR PRIVATE KEYS, ARISING FROM:
...
THIS AGREEMENT (TOGETHER WITH THE AGPL-3.0 SOFTWARE LICENSE) CONSTITUTES THE ENTIRE AGREEMENT BETWEEN YOU AND SynapseStrike REGARDING THE SUBJECT MATTER.
